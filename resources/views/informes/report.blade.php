...
<body>
    <div class="container">
        ...
        <form action="{{route ('report.store')}} " method="post" enctype="multipart/form-data">
            @csrf
                <input type="string" name="graphic" placeholder="grafico de progreso">
                <input type="integer" name="qualification" placeholder="calificacion del informe">
                <input type="string" name="detaillevelmostplayed" placeholder="detalles nivel mas jugado informe">
                <input type="string" name="mostplayedlevellist=$request" placeholder="lista del nivel mas jugado">
